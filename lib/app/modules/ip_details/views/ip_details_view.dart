                      ...
                      child: Obx(
                        () => Container(
                          decoration: BoxDecoration(
                            color: (controller.homeController.ipDetails.value
                                        .countryCode ==
                                    null)
                                ? Colors.red.shade300
                                : null,
                          ...
                          height: 55.0,
                          width: 80.0,
                          child: (controller.homeController.ipDetails.value
                                      .countryCode ==
                                  null)
                              ? const CsIcon(
                                  Icons.flag,
                    ...
                    Expanded(
                      child: CSCard(
                        ...
                        children: [
                          ...
                          verticalSpaceRegular,
                          CSText(
                              controller.homeController.ipDetails.value.isp ??
                                  'fetching...'),
                          verticalSpaceRegular
                        ],
                      ),
                    ...
                    Expanded(
                      child: CSCard(
                        ...
                        children: [
                          ...
                          verticalSpaceRegular,
                          CSText(controller
                                  .homeController.ipDetails.value.timezone ??
                              'fetching...'),
                          verticalSpaceRegular
                        ],
                      ),
                    ...
                    Expanded(
                      child: CSCard(
                        ...
                        children: [
                          ...
                          verticalSpaceRegular,
                          CSText(
                              controller.homeController.ipDetails.value.zip ??
                                  'fetching...'),
                          verticalSpaceRegular
                        ],
                      ),
